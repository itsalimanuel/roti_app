...
class RotiSitting extends StatefulWidget {
  @override
  _RotiSittingAddress createState() => new _RotiSittingAddress();
}

class _RotiSittingAddress extends State<RotiSitting> {
  ...
  Future _saveProfile() async {
    ...
    userMap[fullName] = _nameController.text;
    userMap[phoneNumber] = _mobileController.text;
