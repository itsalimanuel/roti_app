...
import 'package:roti_app/UserScreen/paymentOrder.dart';
...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final Size screenSize = MediaQuery
        .of(context)
        .size;
    var streamBuilder = new StreamBuilder(stream: FirebaseDatabase.instance
        .reference()
        .child(AppData.cartDB)
        .child(AppData.currentUserID)
        .orderByValue()
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.hasData) {
          ...
          final cartSummary = new Padding(padding: const EdgeInsets.all(8.0),
            child: new Container(
              margin: new EdgeInsets.only(top: 5.0, left: 5.0, right: 5.0),
              child: new Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  new Text("Item(${length == 0 ? "0" : fbconn.getDataSize()
                      .toString()})",
                    style: new TextStyle(
          ...
          final firstList = new Flexible(
            child: new ListView.builder(scrollDirection: Axis.vertical,
              itemCount: length,
                            ...
                            child: new Row(
                              ...
                              children: <Widget>[
                                new Padding(
                                  padding: const EdgeInsets.all(3.0),
                                  child: new Icon(
                                    Icons.favorite_border, size: 18.0,
                                    color: MyApp.appColors[600],),
                                ),
                        ...
                        child: new Row(
                          children: <Widget>[
                            ...
                            new CupertinoButton(
                              ...
                              onPressed: () {
                                removeQuantity(
                                    fbconn.getKeyIDasList()[index],
                                    fbconn.getItemQuantityAsList()[index]);
                              },
                            ),
                            new Text(fbconn.getItemQuantityAsList()[index]
                                .toString(),
                              style: const TextStyle(
                                  color: const Color(0xFF8E8E93),
                                  fontSize: 13.0,
                ...
                child: new Column(
                  ...
                  children: <Widget>[
                    ...
                    new Padding(padding: const EdgeInsets.all(5.0),
                      child: new Text("You have no item in your cart...",
                        style: new TextStyle(
            ...
            return new Column(
              children: <Widget>[
                ...
                new Container(
                  ...
                  child: new GestureDetector(
                    onTap: (){
                      Navigator.of(context).push(new CupertinoPageRoute(builder: (BuildContext context)=> new OrderSummary(
                        cartTotal:fbconn.getTotalProductPrice().toString(),
                        totalItems: fbconn.getDataSize().toString(),
                      )));
                    },
                    child:  new Container(
                      width: screenSize.width,
                      margin: new EdgeInsets.only(left: 10.0,right: 10.0,bottom: 2.0),
                      height: 50.0,
                      decoration: new BoxDecoration(
                        color: MyApp.appColors[600],
                        borderRadius:
