...
import 'package:roti_app/UserScreen/payment.dart';
        ...
        child: new ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new RotiLogin())); //SupportAccountRecovery
              },
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new UserOrder()));
              },
            ),
            new Divider(),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) =>
                    new RotiLogin())); //SupportAccountRecovery
              },
            ),
          ],
        ),
